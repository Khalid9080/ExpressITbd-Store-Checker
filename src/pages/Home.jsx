...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col items-center gap-16 ">
      ...
      <div className="px-5">
        <div ref={formRef} className="w-full max-w-3xl bg-gray-50 rounded-md shadow-xl px-8 py-10 sm:p-10  ">
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4">
              ...
              <div className="w-full lg:w-[278px] sm:w-[278px] ">
                <select
                  value={currency}
